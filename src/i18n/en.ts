 ...
 * Covers all hardcoded Chinese text (Records/Review/Thoughts/Insights tabs, buttons, hints, settings, etc.)
 */
...
export const en: TranslationDict = {
  ...
  // Issue 1: stats subtitle relocated to module top-left (Records/Review/Thoughts)
  ...
  // Header page-title mapping: Records=Baimiao (others reuse tab.*)
  ...
  // --- Search panel ---
  'search.placeholder': 'Search records, diaries, distillations...',
  'search.cancel': 'Cancel',
  'search.recent': 'Recent searches',
  'search.emptyHint': 'Enter keywords to find your inspiration records',
  ...
  'record.inputPlaceholder': 'Type a record to capture...',
  ...
  'record.confirmDelete': 'Delete this record? This cannot be undone.',
  'record.save': 'Save',
  ...
  'review.noFragmentsGen': 'No records for this day. Cannot generate a review.',
  'review.noFragmentsRegen': 'No records for this day. Cannot regenerate the review.',
  'review.emptyTodayTitle': 'No review content for today yet',
  'review.emptyTodayDesc': 'Let AI summarize your day',
  'review.todayFragmentsCount': 'You captured {count} records today',
  ...
  'thoughts.dateEmptyTitle': 'No thoughts on {date}',
  'thoughts.dateEmptyDesc': 'Try switching dates at the top, or go back to today.',
  'thoughts.backToToday': 'Back to today',
  'thoughts.doubleClickEdit': 'Double-click to edit',
  'thoughts.cardHint': 'Click to expand/collapse, double-click to edit',
  'thoughts.addTag': 'Add tag',
  'thoughts.tagPlaceholder': 'Tag path',
  ...
  'thoughts.filterHint': '{date} · {count} notes',
  'thoughts.viewAll': 'View full timeline',
  ...
  'insight.custom': 'Custom',         // C4 5-slot: custom insight_type fallback name
  'insight.selectTemplate': 'Select templates (multi-select)',
  'insight.generateNInsights': 'Generate {count} insight(s)',
  ...
  'insight.generatingMingwuDesc': 'Contemplating records and distillations, surfacing life patterns',
  'insight.startTitle': 'Begin your insight journey',
  'insight.startDesc': 'Click the button below to let AI contemplate your records and distillations over this period, surfacing awakenings and insights.',
  ...
  'settings.embeddingApiKeyRequired': 'Embedding API key is required',
  ...
  // Issue #004: Transcription hallucination filter
  'settings.transcriptionFilterTitle': 'Transcription hallucination filter',
  'settings.transcriptionFilterDesc1': 'When transcribing audio, the LLM may output fixed noise fragments (such as "[EMPTY_AUDIO]" or "Thanks for watching"). Patterns configured here are sent to the backend on every transcription; matched transcriptions will be discarded or flagged.',
  'settings.transcriptionFilterDesc2': 'The configuration is stored only in this device\'s IndexedDB (settings_kv table) and is not synced to the cloud.',
  'settings.transcriptionFilterEmpty': 'No patterns yet. Click the button below to add one.',
  'settings.addPattern': 'Add pattern',
  'settings.resetDefault': 'Reset to defaults',
  'settings.type': 'Type',
  'settings.exactMatch': 'Exact match',
  'settings.regex': 'Regex',
  'settings.patternPlaceholderExact': 'e.g. [EMPTY_AUDIO]',
  'settings.patternPlaceholderRegex': 'e.g. follow.*subscribe',
  'settings.patternDescPlaceholder': 'Note (optional)',
  'settings.confirmResetPatterns': 'Restore all default patterns? Custom patterns will be lost.',
  'settings.tts': 'Text-to-Speech (TTS)',
  'settings.ttsDesc': 'Provides read-aloud for AI-generated reviews, insights, and chat replies. Records and distillations are not supported.',
  ...
  'settings.ttsPresetVoicesAvailable': '{count} preset voices available',
  ...
  'settings.storagePressureUsed': 'Used',
  'settings.storagePressureWarning': '⚠️ Storage space is tight. Export a backup now ({pct}% ≥ 85%).',
  'settings.activatingStorage': 'Activating storage protection...',
  'settings.activateStorage': '🔒 Activate permanent storage protection',
  'settings.storageActivatingSuccess': 'Permanent storage activated!',
  'settings.autoBackup': 'Local auto backup',
  'settings.autoBackupDesc': 'Keep last 4 weeks (28 days) of data snapshots. Backups exclude audio attachments (too large) and embeddings (rebuildable).',
  'settings.autoBackupOn': 'Auto backup enabled',
  'settings.autoBackupOff': 'Auto backup disabled',
  'settings.autoBackupNow': 'Backup now',
  'settings.autoBackupCreating': 'Backing up…',
  'settings.autoBackupList': 'Backup history',
  'settings.backupCountAndSize': '{count} · {size} KB',
  'settings.autoBackupEmpty': 'No backups yet',
  'settings.autoBackupRestore': 'Restore',
  'settings.autoBackupDelete': 'Delete',
  'settings.autoBackupSize': 'Size',
  'settings.autoBackupTime': 'Time',
  'settings.autoBackupType': 'Type',
  'settings.autoBackupRestoreConfirm': 'Restore will clear current data and replace it with this backup. Continue?',
  'settings.autoBackupRestoreSuccess': 'Restored. Please refresh the page to see the latest data.',
  'settings.autoBackupDeleteConfirm': 'Delete this backup?',
  ...
  // Issue #006: Error log debug panel
  'settings.errorLogTitle': 'Error log (debug)',
  'settings.errorLogDesc': 'Local circular buffer stored only in this device\'s memory. Export JSON and send it to the developer to help diagnose issues.',
  'settings.lastExport': 'Last export: {time}',
  'settings.confirmClearErrorLog': 'Clear error log?',
  'settings.triggerTest': 'Trigger test',
  ...
  'settings.insightAutoOrganizeTitle': '🔮 Insight auto-organize',
  'settings.insightAutoOrganizeDesc': 'Auto-generate last week\'s insights at 00:01 every Monday and last month\'s insights at 00:01 on the 1st. Uses the prompt slots checked in "Auto-generate selected"; silently skips periods with no records.',
  ...
  'copilot.semanticOffDesc': 'Copilot relies on local vector retrieval to search your records, diaries, and reviews. Please configure and enable the embedding model in Settings first.',
  ...
  'tags.emptyHint': 'Type #tag in records to auto-create',
  ...
  // --- CalendarHeatmap ---
  'calendarHeatmap.record': 'Records',
  'calendarHeatmap.diary': 'Diary',
  'calendarHeatmap.review': 'Review',
  'calendarHeatmap.thoughts': 'Thoughts',
