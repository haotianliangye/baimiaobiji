...
export const en: TranslationDict = {
  ...
  // --- Insights / Mingwu page ---
  'mingwu.title': 'Insights',
  'mingwu.mingwu': 'Awakening',
  'mingwu.insight': 'Insight',
  'mingwu.noSummary': 'No summary available',
  'mingwu.saveFailed': 'Save failed: {msg}',
  'mingwu.generate': 'Generate',
  'mingwu.generating': 'Generating...',
  'mingwu.regenerate': 'Regenerate',
  'mingwu.copy': 'Copy',
  'mingwu.copied': 'Copied',
  'mingwu.edit': 'Edit',
  'mingwu.save': 'Save',
  'mingwu.saving': 'Saving…',
  'mingwu.cancel': 'Cancel',
  'mingwu.delete': 'Delete',
  'mingwu.chatWithAI': 'Chat with AI',
  'mingwu.readAloud': 'Read aloud',
  'mingwu.stopReading': 'Stop',
  'mingwu.expand': 'Expand',
  'mingwu.collapse': 'Collapse',
  'mingwu.emptyTitle': 'No insights yet',
  'mingwu.emptyDesc': 'Select a time range to generate deep insights',
  'mingwu.confirmDelete': 'Delete this record?',
  'mingwu.rangeWeek': 'This week',
  'mingwu.rangeMonth': 'This month',
  'mingwu.rangeQuarter': 'This quarter',
  'mingwu.rangeCustom': 'Custom',
