...
export const zh: TranslationDict = {
  ...
  'thoughts.dateEmptyTitle': '{date} 没有沉淀',
  'thoughts.dateEmptyDesc': '试试在顶部切换日期，或回到今天继续记录。',
  'thoughts.backToToday': '回到今天',
  'thoughts.doubleClickEdit': '双击编辑',
  'thoughts.cardHint': '单击展开/收起，双击编辑',
  'thoughts.addTag': '添加标签',
  'thoughts.tagPlaceholder': '标签路径',
  'thoughts.expand': '展开',
  ...
  'thoughts.filterHint': '{date} · {count} 条',
  'thoughts.viewAll': '查看全部时间线',
  ...
  'insight.mingwu': '明悟',
  'insight.insight': '洞察',
  'insight.custom': '自定义',        // C4 5 槽：custom insight_type 兜底名
  'insight.selectTemplate': '选择生成模板（可多选）',
  'insight.generateNInsights': '生成 {count} 篇洞察',
  'insight.noSummary': '暂无内容概要',
  'insight.saveFailed': '保存失败：{msg}',
  'insight.generate': '生成',
  'insight.generating': '生成中...',
  'insight.regenerate': '重新生成',
  'insight.copy': '复制',
  'insight.copied': '已复制',
  'insight.edit': '编辑',
  'insight.save': '保存',
  ...
  'insight.cancel': '取消',
  'insight.delete': '删除',
  'insight.chatWithAI': '与 AI 对话',
  'insight.readAloud': '朗读',
  'insight.stopReading': '停止',
  'insight.expand': '展开',
  'insight.collapse': '收起',
  'insight.emptyTitle': '暂无洞察',
  'insight.emptyDesc': '选择时间范围生成深度洞察与明悟',
  'insight.confirmDelete': '确认删除这条记录吗？',
  'insight.rangeWeek': '本周',
  'insight.rangeMonth': '本月',
  'insight.rangeQuarter': '本季度',
  'insight.rangeCustom': '自定义',
  'insight.rangeDay': '今日',
  'insight.rangeHalfYear': '半年',
  'insight.rangeYear': '一年',
  'insight.rangeCustomRange': '自选',
  ...
  'settings.apiKeyRequired': 'API Key 不能为空',
  'settings.embeddingApiKeyRequired': '向量 API Key 不能为空',
  ...
  // Issue #004: 转写幻觉过滤
  'settings.transcriptionFilterTitle': '转写幻觉过滤',
  'settings.transcriptionFilterDesc1': 'LLM 转写音频时可能输出固定的噪音片段（如「[EMPTY_AUDIO]」「谢谢观看」）。这里配置的 patterns 会在每次转写时送给后端，被命中的转写会被丢弃或标记。',
  'settings.transcriptionFilterDesc2': '配置仅存于本设备的 IndexedDB（settings_kv 表），不参与云同步。',
  'settings.transcriptionFilterEmpty': '还没有任何 pattern，点击下方按钮添加',
  'settings.addPattern': '添加 pattern',
  'settings.resetDefault': '恢复默认',
  'settings.type': '类型',
  'settings.exactMatch': '精确匹配',
  'settings.regex': '正则表达式',
  'settings.patternPlaceholderExact': '例如：[EMPTY_AUDIO]',
  'settings.patternPlaceholderRegex': '例如：关注.*订阅',
  'settings.patternDescPlaceholder': '备注（可选）',
  'settings.confirmResetPatterns': '确定要恢复全部默认 patterns 吗？自定义内容会丢失。',
  ...
  'settings.ttsPresetVoicesAvailable': '{count} 个预置音色可选',
  // #009: TTS 外部 API 配置
  ...
  'settings.storagePressureUsed': '已使用',
  'settings.storagePressureWarning': '⚠️ 存储空间紧张，建议立即导出备份（{pct}% ≥ 85%）。',
  ...
  'settings.autoBackupDesc': '保留最近 4 周（28 天）数据快照。备份不含音频附件（太大）和向量（可重建）。',
  'settings.autoBackupOn': '自动备份已开启',
  'settings.autoBackupOff': '自动备份已关闭',
  'settings.autoBackupNow': '立即手动备份',
  'settings.autoBackupCreating': '备份中…',
  'settings.autoBackupList': '历史备份',
  'settings.backupCountAndSize': '{count} 条 · {size} KB',
  'settings.autoBackupEmpty': '暂无备份',
  'settings.autoBackupRestore': '恢复',
  'settings.autoBackupDelete': '删除',
  'settings.autoBackupSize': '大小',
  'settings.autoBackupTime': '时间',
  'settings.autoBackupType': '类型',
  'settings.autoBackupRestoreConfirm': '恢复会清空当前数据并替换为该备份的内容。是否继续？',
  'settings.autoBackupRestoreSuccess': '已恢复。请刷新页面查看最新数据。',
  'settings.autoBackupDeleteConfirm': '确定要删除这条备份吗？',
  ...
  // Issue #006: 错误日志调试面板
  'settings.errorLogTitle': '错误日志（调试）',
  'settings.errorLogDesc': '本地环形缓冲，仅在本设备内存。导出 JSON 发给开发者辅助定位问题。',
  'settings.lastExport': '上次导出：{time}',
  'settings.confirmClearErrorLog': '确定清空错误日志？',
  'settings.triggerTest': '触发测试',
  ...
  'settings.insightAutoOrganizeTitle': '🔮 洞察自动整理',
  'settings.insightAutoOrganizeDesc': '每周一凌晨 00:01 自动生成上周的洞察；每月 1 号凌晨 00:01 自动生成上个月的洞察。使用「自动生成选中」中勾选的 prompt 槽位；该周期内若无任何记录会静默跳过。',
  ...
  'copilot.moduleRecord': '识微',
  'copilot.moduleReview': '回顾',
  'copilot.moduleThoughts': '沉淀',
  'copilot.moduleInsight': '洞察',
  'copilot.historyDateLabel': '日期',
  'copilot.clearDate': '清空',
  'copilot.historySelectDate': '选择日期',
