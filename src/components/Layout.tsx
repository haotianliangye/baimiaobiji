        ...
        <header className="flex h-[54px] shrink-0 items-center justify-between px-4 bg-gradient-to-r from-baimiao-mysteria to-[#2c2957] text-white/95 border-b border-white/5">
          <div className="flex items-center gap-2">
            <h1 
              ...
              className="text-[18px] font-bold font-serif tracking-widest cursor-pointer hover:opacity-80 transition-opacity active:scale-[0.98] select-none translate-y-[0.8px]"
            >
              白描笔记
            </h1>
