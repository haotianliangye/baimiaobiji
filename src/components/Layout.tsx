      ...
      <div className="w-full max-w-md h-full bg-[#f4f4f0] shadow-sm ring-1 ring-black/5 flex flex-col relative overflow-hidden">
        ...
        <header className="flex h-[54px] shrink-0 items-center justify-between px-4 bg-black text-white">
          <div className="flex items-center gap-2">
            ...
            {isProcessingQueue && autoGenTasks.length > 0 && (
              <span className="flex items-center gap-1 bg-stone-800 text-stone-300 text-[10px] px-2 py-0.5 rounded-full font-medium select-none tracking-wide animate-pulse">
                <Loader2 className="w-2.5 h-2.5 animate-spin text-stone-400" />
                AI 整理中 ({autoGenTasks.length})
              </span>
            )}
          </div>
