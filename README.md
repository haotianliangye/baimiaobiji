...
**白描 Copilot（智能助理）**
- 基于本地向量数据库的 RAG 检索对话，支持跨时空的拾微、日记、回顾、洞察内容查询
...
**搜索（关键词）**
- 覆盖拾微、日记、回顾、洞察四类，关键词高亮预览，按时间/模块过滤
...
| 标签 | 图标 | 设计依据 |
|:---|:---|:---|
| 拾微 | 💬 聊天气泡 (`ChatCircleDots`) | 拾微记录是轻量、碎片化的"只言片语" |
| 回顾 | 🕐 时钟 (`Clock`) | 时间轴回溯，跨日统计复盘 |
| 沉淀 | 🧠 头脑电路 (`HeadCircuit`) | 深度沉淀与长文笔记 |
| 洞察 | ☀️ 太阳 (`SunDim`) | 洞察、点亮，区别于沉淀的头脑图标 |
